...
const RealLeaderboard = ({ onClose, currentScore }: RealLeaderboardProps) => {
  ...
  const shareScore = async (score: number, username: string) => {
        ...
        <CardContent className="space-y-4">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-gray-400">
                        {entry.bike_used} • {new Date(entry.created_at).toLocaleDateString()}
                      </div>
                    </div>
                  </div>
          ...
          {currentScore && (
            <div className="pt-4 border-t border-gray-700">
              <Button
                onClick={() => shareScore(currentScore, 'Your')}
