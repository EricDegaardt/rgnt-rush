...
const GameUI = ({
  ...
  return <div className="absolute top-4 left-1/2 transform -translate-x-1/2 text-white flex flex-row items-center gap-2 sm:gap-4 p-2 bg-black bg-opacity-50 rounded text-xs md:text-base">
