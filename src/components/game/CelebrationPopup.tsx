    ...
    <div className="fixed inset-0 bg-black/90 flex items-center justify-center z-[10000] pointer-events-auto">
      ...
      >
        ...
        <div className="flex flex-col gap-4 mt-4">
          <button
            onClick={onShare}
            className={`w-full py-3 px-6 rounded-lg font-bold text-white transition-all transform hover:scale-105 bg-gradient-to-r from-yellow-400 to-pink-500 hover:from-yellow-500 hover:to-pink-600 shadow-lg shadow-yellow-400/25`}
          >
            Share Score
          </button>
          <button
            onClick={onPlayAgain}
            className={`w-full py-3 px-6 rounded-lg font-bold text-white transition-all transform hover:scale-105 bg-purple-600 hover:bg-purple-700`}
          >
            Play Again
          </button>
        </div>
